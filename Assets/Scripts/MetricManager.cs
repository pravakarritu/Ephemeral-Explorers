...
public class MetricManager : MonoBehaviour
{
    ...
    // string result = string.Format("https://docs.google.com/forms/u/5/d/e/1FAIpQLSdGjXOFO-4U50HRFrV0JlfMlTVqFL7456SmMlCHmBClU1rlzg/formResponse?entry.1928979965={0}&entry.1727223128={1}&entry.2075213155={2:0.00}&entry.1334567754={3:0.00}&entry.830705189={4:0.00}&entry.929535121={5:0.00}&entry.1300638476={6:0.00}", diminishPowerGet, numberOfBoxMovements,numberOfJumpsSuccess, level1, level2,level3,level4,level5);
