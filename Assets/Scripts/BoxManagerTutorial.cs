...
public class BoxManagerTutorial : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        clearPanel = GameObject.FindWithTag("ClearPanelUI");
        clearPanel.SetActive(false);
    }

    void Update()
    {
        if (tutorialLevel == 1 && boxMap[0][0] == 2 && boxMap[0][1] == 0 && boxMap[1][0] == 1) {
            clearPanel.SetActive(true);
        }
        else if (tutorialLevel == 2 && playerCtr.GetKeyGet()) {
            clearPanel.SetActive(true);
        }
